    ...
    then
        ...
        then
            ...
            then
                ...
                then
                    #clean
                    xcodebuild clean -project $project_Name.xcodeproj -scheme $project_Name -configuration $configuration
                    xcodebuild archive -project $project_Name.xcodeproj -scheme $project_Name -archivePath ./$project_Name.xcarchive
                    if [ "$parameter" = "1" ]
                    then
